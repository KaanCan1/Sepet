...
INSERT INTO categories (code, name) VALUES
  ...
  -- Tuz, sirke, sos: hiçbir gıda başlığına oturmayanlar. COICOP'un kendi
  -- bölümü, uydurma değil.
  ('01.1.9', 'Diğer gıda ürünleri')
...
SELECT b.name, trim(normalize_raw_text(b.name))
  FROM (VALUES
    ...
    -- Genişletme: gündelik sepette sık geçen ama katalogda karşılığı
    -- olmayan kalemlerin markaları.
    ('Lays'), ('Ruffles'), ('Doritos'), ('Patos'),
    ('Nestlé'), ('Milka'), ('Koska'), ('Algida'), ('Balparmak'),
    ('Anavarza'), ('Namet'), ('Aytaç'), ('Sana'), ('Marmarabirlik'),
    ('Dimes'), ('Cappy'), ('Uludağ'), ('Beypazarı'),
    ('Yumoş'), ('Finish'), ('Cif'), ('Papia'),
    ('Arko'), ('Dalin'), ('Rexona'), ('Orkid'), ('Molped'),
    ('Prima'), ('Sleepy'), ('Hayat')
  ) AS b (name)
...
SELECT g.name, g.unit::product_unit, c.id
  FROM (VALUES
    ...
    -- ── Genişletme ────────────────────────────────────────────────────────
    -- Gündelik sepette sık geçen ama katalogda karşılığı olmayan kalemler.
    -- Eksik grup kullanıcıyı ürün tanımlamaya zorluyor; tanımlama çıkmazı
    -- kaldırıyor ama eksikliğin SIKLIĞINI düşürmek ayrı bir iş.
    ('Ekmek, beyaz',              'kilogram', '01.1.1'),
    ('Bisküvi',                   'kilogram', '01.1.1'),
    ('Kraker',                    'kilogram', '01.1.1'),
    ('Kahvaltılık gevrek',        'kilogram', '01.1.1'),
    ('Sucuk',                     'kilogram', '01.1.2'),
    ('Salam',                     'kilogram', '01.1.2'),
    ('Sosis',                     'kilogram', '01.1.2'),
    ('Tavuk but',                 'kilogram', '01.1.2'),
    ('Krem peynir',               'kilogram', '01.1.4'),
    ('Tulum peyniri',             'kilogram', '01.1.4'),
    ('Kaymak',                    'kilogram', '01.1.4'),
    ('Margarin',                  'kilogram', '01.1.5'),
    ('Mısır yağı',                'litre',    '01.1.5'),
    ('Limon',                     'kilogram', '01.1.6'),
    ('Üzüm',                      'kilogram', '01.1.6'),
    ('Karpuz',                    'kilogram', '01.1.6'),
    ('Çilek',                     'kilogram', '01.1.6'),
    ('Mandalina',                 'kilogram', '01.1.6'),
    ('Havuç',                     'kilogram', '01.1.7'),
    ('Patlıcan',                  'kilogram', '01.1.7'),
    ('Kabak',                     'kilogram', '01.1.7'),
    ('Marul',                     'kilogram', '01.1.7'),
    ('Zeytin, siyah',             'kilogram', '01.1.7'),
    ('Zeytin, yeşil',             'kilogram', '01.1.7'),
    ('Cips',                      'kilogram', '01.1.7'),
    ('Çikolata',                  'kilogram', '01.1.8'),
    ('Bal',                       'kilogram', '01.1.8'),
    ('Reçel',                     'kilogram', '01.1.8'),
    ('Helva',                     'kilogram', '01.1.8'),
    ('Dondurma',                  'litre',    '01.1.8'),
    ('Tuz',                       'kilogram', '01.1.9'),
    ('Sirke',                     'litre',    '01.1.9'),
    ('Ketçap',                    'kilogram', '01.1.9'),
    ('Mayonez',                   'kilogram', '01.1.9'),
    ('Kahve, hazır',              'kilogram', '01.2.1'),
    ('Bitki çayı',                'adet',     '01.2.1'),
    ('Meyve suyu',                'litre',    '01.2.2'),
    ('Gazoz',                     'litre',    '01.2.2'),
    ('Maden suyu',                'litre',    '01.2.2'),
    ('Yumuşatıcı, çamaşır',       'litre',    '05.6.1'),
    ('Bulaşık makinesi deterjanı', 'adet',     '05.6.1'),
    ('Yüzey temizleyici',         'litre',    '05.6.1'),
    ('Peçete',                    'adet',     '05.6.1'),
    ('Çöp poşeti',                'adet',     '05.6.1'),
    ('Saç kremi',                 'litre',    '12.1.3'),
    ('Duş jeli',                  'litre',    '12.1.3'),
    ('Sabun, katı',               'kilogram', '12.1.3'),
    ('Deodorant',                 'litre',    '12.1.3'),
    ('Ped, hijyenik',             'adet',     '12.1.3'),
    ('Bebek bezi',                'adet',     '12.1.3'),
    ('Islak mendil',              'adet',     '12.1.3')
...
VALUES
    ...
    -- ── Genişletme ────────────────────────────────────────────────────────
    -- Her yeni gruba en az bir marka; boy çaprazlaması aşağıda.
    ('Ekmek, beyaz',                NULL,                    '500 g',         0.5),
    ('Bisküvi',                     'Eti',                   '100 g',         0.1),
    ('Bisküvi',                     'Ülker',                 '100 g',         0.1),
    ('Kraker',                      'Eti',                   '100 g',         0.1),
    ('Kraker',                      'Ülker',                 '100 g',         0.1),
    ('Kahvaltılık gevrek',          'Nestlé',                '450 g',         0.45),
    ('Kahvaltılık gevrek',          'Ülker',                 '400 g',         0.4),
    ('Sucuk',                       'Pınar',                 '400 g',         0.4),
    ('Sucuk',                       'Namet',                 '400 g',         0.4),
    ('Sucuk',                       'Aytaç',                 '400 g',         0.4),
    ('Salam',                       'Pınar',                 '200 g',         0.2),
    ('Salam',                       'Namet',                 '200 g',         0.2),
    ('Sosis',                       'Pınar',                 '250 g',         0.25),
    ('Sosis',                       'Namet',                 '250 g',         0.25),
    ('Tavuk but',                   NULL,                    'kilogram',      1.0),
    ('Tavuk but',                   'Banvit',                'kilogram',      1.0),
    ('Krem peynir',                 'Pınar',                 '180 g',         0.18),
    ('Krem peynir',                 'İçim',                  '180 g',         0.18),
    ('Tulum peyniri',               NULL,                    'kilogram',      1.0),
    ('Tulum peyniri',               'İçim',                  '250 g',         0.25),
    ('Kaymak',                      'Sek',                   '200 g',         0.2),
    ('Kaymak',                      'Pınar',                 '200 g',         0.2),
    ('Margarin',                    'Sana',                  '250 g',         0.25),
    ('Margarin',                    'Bizim',                 '250 g',         0.25),
    ('Mısır yağı',                  'Yudum',                 '1 litre',       1.0),
    ('Mısır yağı',                  'Orkide',                '1 litre',       1.0),
    ('Limon',                       NULL,                    'kilogram',      1.0),
    ('Üzüm',                        NULL,                    'kilogram',      1.0),
    ('Karpuz',                      NULL,                    'kilogram',      1.0),
    ('Çilek',                       NULL,                    'kilogram',      1.0),
    ('Mandalina',                   NULL,                    'kilogram',      1.0),
    ('Havuç',                       NULL,                    'kilogram',      1.0),
    ('Patlıcan',                    NULL,                    'kilogram',      1.0),
    ('Kabak',                       NULL,                    'kilogram',      1.0),
    ('Marul',                       NULL,                    'kilogram',      1.0),
    ('Zeytin, siyah',               'Marmarabirlik',         '400 g',         0.4),
    ('Zeytin, siyah',               NULL,                    'kilogram',      1.0),
    ('Zeytin, yeşil',               'Marmarabirlik',         '400 g',         0.4),
    ('Zeytin, yeşil',               NULL,                    'kilogram',      1.0),
    ('Cips',                        'Lays',                  '150 g',         0.15),
    ('Cips',                        'Ruffles',               '150 g',         0.15),
    ('Cips',                        'Doritos',               '150 g',         0.15),
    ('Cips',                        'Patos',                 '100 g',         0.1),
    ('Çikolata',                    'Ülker',                 '80 g',          0.08),
    ('Çikolata',                    'Nestlé',                '80 g',          0.08),
    ('Çikolata',                    'Milka',                 '80 g',          0.08),
    ('Çikolata',                    'Eti',                   '80 g',          0.08),
    ('Bal',                         'Balparmak',             '460 g',         0.46),
    ('Bal',                         'Anavarza',              '460 g',         0.46),
    ('Reçel',                       'Tamek',                 '380 g',         0.38),
    ('Reçel',                       'Bizim',                 '380 g',         0.38),
    ('Helva',                       'Koska',                 '350 g',         0.35),
    ('Helva',                       'Torku',                 '350 g',         0.35),
    ('Dondurma',                    'Algida',                '900 mL',        0.9),
    ('Dondurma',                    'Torku',                 '900 mL',        0.9),
    ('Tuz',                         'Bizim',                 '750 g',         0.75),
    ('Tuz',                         'Hayat',                 '750 g',         0.75),
    ('Sirke',                       'Tamek',                 '1 litre',       1.0),
    ('Sirke',                       'Bizim',                 '1 litre',       1.0),
    ('Ketçap',                      'Tat',                   '600 g',         0.6),
    ('Ketçap',                      'Tamek',                 '600 g',         0.6),
    ('Mayonez',                     'Tat',                   '600 g',         0.6),
    ('Mayonez',                     'Tamek',                 '600 g',         0.6),
    ('Kahve, hazır',                'Nescafe',               '100 g',         0.1),
    ('Kahve, hazır',                'Jacobs',                '100 g',         0.1),
    ('Bitki çayı',                  'Lipton',                '20''li',        20.0),
    ('Bitki çayı',                  'Ofçay',                 '20''li',        20.0),
    ('Meyve suyu',                  'Dimes',                 '1 litre',       1.0),
    ('Meyve suyu',                  'Cappy',                 '1 litre',       1.0),
    ('Meyve suyu',                  'Tamek',                 '1 litre',       1.0),
    ('Gazoz',                       'Uludağ',                '1 litre',       1.0),
    ('Gazoz',                       'Fanta',                 '1 litre',       1.0),
    ('Maden suyu',                  'Beypazarı',             '200 mL',        0.2),
    ('Maden suyu',                  'Uludağ',                '200 mL',        0.2),
    ('Yumuşatıcı, çamaşır',         'Yumoş',                 '1,44 litre',    1.44),
    ('Yumuşatıcı, çamaşır',         'Bizim',                 '1,44 litre',    1.44),
    ('Bulaşık makinesi deterjanı',  'Finish',                '30''lu',        30.0),
    ('Bulaşık makinesi deterjanı',  'Fairy',                 '30''lu',        30.0),
    ('Yüzey temizleyici',           'Cif',                   '750 mL',        0.75),
    ('Yüzey temizleyici',           'Domestos',              '750 mL',        0.75),
    ('Peçete',                      'Selpak',                '100''lü',       100.0),
    ('Peçete',                      'Papia',                 '100''lü',       100.0),
    ('Çöp poşeti',                  'Solo',                  '10''lu',        10.0),
    ('Çöp poşeti',                  'Bizim',                 '10''lu',        10.0),
    ('Saç kremi',                   'Elidor',                '500 mL',        0.5),
    ('Saç kremi',                   'Duru',                  '500 mL',        0.5),
    ('Duş jeli',                    'Duru',                  '500 mL',        0.5),
    ('Duş jeli',                    'Arko',                  '500 mL',        0.5),
    ('Sabun, katı',                 'Duru',                  '150 g',         0.15),
    ('Sabun, katı',                 'Arko',                  '150 g',         0.15),
    ('Deodorant',                   'Rexona',                '150 mL',        0.15),
    ('Deodorant',                   'Arko',                  '150 mL',        0.15),
    ('Ped, hijyenik',               'Orkid',                 '16''lı',        16.0),
    ('Ped, hijyenik',               'Molped',                '16''lı',        16.0),
    ('Bebek bezi',                  'Prima',                 '30''lu',        30.0),
    ('Bebek bezi',                  'Sleepy',                '30''lu',        30.0),
    ('Islak mendil',                'Sleepy',                '60''lı',        60.0),
    ('Islak mendil',                'Dalin',                 '60''lı',        60.0)
  ;
...
VALUES
    ...
    ('Kraker',                      '100 g',       0.1),
    ('Kraker',                      '200 g',       0.2),
    ('Kahvaltılık gevrek',          '250 g',       0.25),
    ('Kahvaltılık gevrek',          '400 g',       0.4),
    ('Kahvaltılık gevrek',          '450 g',       0.45),
    ('Ekmek, beyaz',                '250 g',       0.25),
    ('Ekmek, beyaz',                '500 g',       0.5),
    ('Sucuk',                       '250 g',       0.25),
    ('Sucuk',                       '400 g',       0.4),
    ('Sucuk',                       '500 g',       0.5),
    ('Salam',                       '200 g',       0.2),
    ...
    ('Sosis',                       '250 g',       0.25),
    ('Sosis',                       '500 g',       0.5),
    ('Krem peynir',                 '180 g',       0.18),
    ('Krem peynir',                 '200 g',       0.2),
    ('Tulum peyniri',               '250 g',       0.25),
    ('Tulum peyniri',               '500 g',       0.5),
    ('Kaymak',                      '150 g',       0.15),
    ('Kaymak',                      '200 g',       0.2),
    ('Kaymak',                      '300 g',       0.3),
    ('Margarin',                    '250 g',       0.25),
    ('Margarin',                    '500 g',       0.5),
    ('Mısır yağı',                  '1 litre',     1.0),
    ('Mısır yağı',                  '2 litre',     2.0),
    ('Mısır yağı',                  '5 litre',     5.0),
    ('Zeytin, siyah',               '400 g',       0.4),
    ('Zeytin, siyah',               '800 g',       0.8),
    ('Zeytin, yeşil',               '400 g',       0.4),
    ('Zeytin, yeşil',               '800 g',       0.8),
    ('Cips',                        '100 g',       0.1),
    ('Cips',                        '150 g',       0.15),
    ('Cips',                        '180 g',       0.18),
    ('Çikolata',                    '60 g',        0.06),
    ...
    ('Mayonez',                     '400 g',       0.4),
    ('Mayonez',                     '600 g',       0.6),
    ('Kahve, hazır',                '50 g',        0.05),
    ('Kahve, hazır',                '100 g',       0.1),
    ('Kahve, hazır',                '200 g',       0.2),
    ('Bitki çayı',                  '20''li',      20.0),
    ('Bitki çayı',                  '40''lı',      40.0),
    ('Meyve suyu',                  '200 mL',      0.2),
    ('Meyve suyu',                  '1 litre',     1.0),
    ('Gazoz',                       '330 mL',      0.33),
    ('Gazoz',                       '1 litre',     1.0),
    ('Gazoz',                       '2,5 litre',   2.5),
    ('Maden suyu',                  '200 mL',      0.2),
    ('Yumuşatıcı, çamaşır',         '1,44 litre',  1.44),
    ('Yumuşatıcı, çamaşır',         '3 litre',     3.0),
    ('Bulaşık makinesi deterjanı',  '30''lu',      30.0),
    ('Bulaşık makinesi deterjanı',  '60''lı',      60.0),
    ('Yüzey temizleyici',           '750 mL',      0.75),
    ('Yüzey temizleyici',           '1 litre',     1.0),
    ('Peçete',                      '100''lü',     100.0),
    ('Peçete',                      '150''li',     150.0),
    ('Çöp poşeti',                  '10''lu',      10.0),
    ('Çöp poşeti',                  '20''li',      20.0),
    ('Saç kremi',                   '350 mL',      0.35),
    ('Saç kremi',                   '500 mL',      0.5),
    ('Duş jeli',                    '500 mL',      0.5),
    ('Duş jeli',                    '750 mL',      0.75),
    ('Sabun, katı',                 '100 g',       0.1),
    ('Sabun, katı',                 '150 g',       0.15),
    ('Deodorant',                   '150 mL',      0.15),
    ('Deodorant',                   '200 mL',      0.2),
    ('Ped, hijyenik',               '16''lı',      16.0),
    ('Ped, hijyenik',               '20''li',      20.0),
    ('Bebek bezi',                  '30''lu',      30.0),
    ('Bebek bezi',                  '60''lı',      60.0),
    ('Islak mendil',                '60''lı',      60.0),
    ('Islak mendil',                '120''li',     120.0);
